...
function TokenHandler(options) {
  ...
  this.authWithoutClientCredentials = options.authWithoutClientCredentials;
  this.allowedGrantTypesWithoutClientCredentials = options.allowedGrantTypesWithoutClientCredentials || [ 'password', 'refresh_token' ];
}
...
TokenHandler.prototype.handle = function(request, response) {
  ...
  const authWithoutClientCredentials = this.authWithoutClientCredentials;
  const allowedGrantTypesWithoutClientCredentials = this.allowedGrantTypesWithoutClientCredentials || [ 'password', 'refresh_token' ];

  return Promise.bind(this)
    .then(function() {
      if(authWithoutClientCredentials) {
        return { grants: allowedGrantTypesWithoutClientCredentials };
      }
